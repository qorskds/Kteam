...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menuMenu:
                return true;
            case R.id.menuTeamMake:
                intent = new Intent(getApplicationContext(), makeAteam.class);
                startActivity(intent);
                return true;
            ...
            case R.id.menuMy:
                ...
                startActivity(intent);
                return true;
            case R.id.menupropose:
                intent = new Intent(getApplicationContext(), MyProposal.class);
                startActivity(intent);
                return true;
